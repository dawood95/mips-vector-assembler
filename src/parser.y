...
label_decl:			LABEL_DECL
								{if (round == 0) symbolTable[string($1)] = currentAddress;};
...
mvtype:					MVADDU REGISTER COMMA REGISTER COMMA REGISTER
								{
										if (round != 0) 
												printR(currentAddress, 0x30, $2, $4, $6, 0, 0x21);
										currentAddress += 4;
								}
				|				MVADD REGISTER COMMA REGISTER COMMA REGISTER
								{
										if (round != 0)
												printR(currentAddress, 0x30, $2, $4, $6, 0, 0x20);
										currentAddress += 4;
								}
				|				MVAND REGISTER COMMA REGISTER COMMA REGISTER
								{
										if (round != 0) 
												printR(currentAddress, 0x30, $2, $4, $6, 0, 0x24);
										currentAddress += 4;
								}
				|				MVNOR REGISTER COMMA REGISTER COMMA REGISTER
								{
										if (round != 0) 
												printR(currentAddress, 0x30, $2, $4, $6, 0, 0x27);
										currentAddress += 4;
								}
				|				MVOR REGISTER COMMA REGISTER COMMA REGISTER
								{
										if (round != 0) 
												printR(currentAddress, 0x30, $2, $4, $6, 0, 0x25);
										currentAddress += 4;
								}
				|				MVSLT REGISTER COMMA REGISTER COMMA REGISTER 
								{
										if (round != 0) 
												printR(currentAddress, 0x30, $2, $4, $6, 0, 0x2a);
										currentAddress += 4;
								}
				|				MVSLTU REGISTER COMMA REGISTER COMMA REGISTER
								{
										if (round != 0) 
												printR(currentAddress, 0x30, $2, $4, $6, 0, 0x2b);
										currentAddress += 4;
								}
				|				MVSLL REGISTER COMMA REGISTER COMMA INTEGER
								{
										if (round != 0) 
												printR(currentAddress, 0x30, $2, $4, 0, $6, 0x00);
										currentAddress += 4;
								}
				|				MVSRL REGISTER COMMA REGISTER COMMA INTEGER
								{
										if (round != 0) 
												printR(currentAddress, 0x30, $2, $4, 0, $6, 0x02);
										currentAddress += 4;
								}
				|				MVSUBU REGISTER COMMA REGISTER COMMA REGISTER
								{
										if (round != 0) 
												printR(currentAddress, 0x30, $2, $4, $6, 0, 0x23);
										currentAddress += 4;
								}
				|				MVSUB REGISTER COMMA REGISTER COMMA REGISTER
								{
										if (round != 0)
												printR(currentAddress, 0x30, $2, $4, $6, 0, 0x22);
										currentAddress += 4;
								}
				|				MVXOR REGISTER COMMA REGISTER COMMA REGISTER
								{
										if (round != 0)
												printR(currentAddress, 0x30, $2, $4, $6, 0, 0x26);
										currentAddress += 4;
								};
...
mvitype:				MVADDIU REGISTER COMMA REGISTER COMMA immediate
								{
										if (round != 0)
												printI(currentAddress, 0x34, $2, $4, $6);
										currentAddress += 4;
								} 
				|				MVADDI REGISTER COMMA REGISTER COMMA immediate
								{
										if (round != 0)
												printI(currentAddress, 0x32, $2, $4, $6);
										currentAddress += 4;
								}
				|				MVANDI REGISTER COMMA REGISTER COMMA immediate
								{
										if (round != 0) 
												printI(currentAddress, 0x37, $2, $4, $6);
										currentAddress += 4;
								}
				|				MVORI REGISTER COMMA REGISTER COMMA immediate
								{
										if (round != 0) 
												printI(currentAddress, 0x38, $2, $4, $6);
										currentAddress += 4;
								}
				|				MVLUI REGISTER COMMA REGISTER COMMA immediate
								{
										if (round != 0) 
												printI(currentAddress, 0x3C, $2, $4, $6);
										currentAddress += 4;
								}
				|				MVXORI REGISTER COMMA REGISTER COMMA immediate
								{
										if (round != 0) 
												printI(currentAddress, 0x3A, $2, $4, $6);
										currentAddress += 4;
								};
